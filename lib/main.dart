...
import 'package:myuiapp/components/travelcard.dart';
                        ...
                        children: [
                          Container(
                            child: ListView(
                              ...
                              children: [
                                travelCard(urls[0], 'Luxary Hotel', 'Mandya', 2),
                                travelCard(urls[2], 'Plzza Hotel', 'Mysuru', 5),
                                travelCard(urls[2], 'Surabi Hotel', 'Srirangapattana', 4),
                              ],
                            ),
                          ),
                          Container(
                            child: ListView(
                              scrollDirection: Axis.horizontal,
                              children: [
                                travelCard(urls[6], 'Amaravathi Hotel', 'Delhi', 3),
                                travelCard(urls[7], 'Hanmantu Hotel', 'Mysuru', 5),
                                travelCard(urls[8], 'Vattari', 'Bombay', 2),
                              ],
                            ),
                          ),
                          Container(
                            child: ListView(
                              scrollDirection: Axis.horizontal,
                              children: [
                                travelCard(urls[8], 'Puttuli Hotel', 'Channei', 3),
                                travelCard(urls[5], 'Mall Hotel', 'Bengaluru', 4),
                                travelCard(urls[4], 'Appu Hotel', 'Heven', 5),
                              ],
                            ),
                          ),
